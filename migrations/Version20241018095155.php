 ...
 */
final class Version20241018095155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id SERIAL NOT NULL, editor_id INT NOT NULL, status VARCHAR(255) NOT NULL, isbn VARCHAR(255) DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, edited_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, plot TEXT DEFAULT NULL, page_number INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE comment (id SERIAL NOT NULL, book_id INT NOT NULL, name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, email VARCHAR(255) NOT NULL, published_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
